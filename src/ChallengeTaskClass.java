...
public class ChallengeTaskClass implements Comparable<ChallengeTaskClass>{
    ...
    public ChallengeTaskClass(String project, String description,
                              String assignee, Priority priority, Status status) {
    ...
    public String toString() {
        return "%-20s %-25s %-10s %-10s %-15s".formatted(
    ...
    public boolean equals(Object o) {
        ...
        ChallengeTaskClass that = (ChallengeTaskClass) o;
        return getProject().equals(that.getProject()) && getDescription().equals(that.getDescription());
    }
